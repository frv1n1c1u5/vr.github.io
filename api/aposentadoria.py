...
def get_ai_analysis(dados_reais, parametros):
    ...
    try:
        ...
        3. Ofereça uma ou duas sugestões práticas e claras sobre como o usuário pode melhorar seu cenário, caso a retirada seja menor que o custo de vida (ex: aumentar aportes, diversificar, etc.).
