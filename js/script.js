...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Lógica para destacar link de navegação da página ativa
    try {
    ...
    if (retirementForm) {
        ...
        const resultsContainer = document.getElementById('report-container');
        ...
        retirementForm.addEventListener('submit', async function(event) {
            ...
            // Limpa os resultados anteriores e mostra uma mensagem de carregamento
            ...
            try {
                ...
                // Recria o HTML completo dos resultados
                resultsContainer.innerHTML = `
                    <div id="result-section">
                        <h3>Análise de Cenários</h3>
                        <div class="chart-container">
                            <canvas id="retirement-chart-canvas"></canvas>
                        </div>
                    ...
                    <button id="download-pdf" class="btn">Exportar para PDF</button>
                `;
                ...
                retirementChart = new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [
                            { label: 'Projeção Mediana', data: results.graficoMediano, borderColor: 'rgb(10, 66, 117)', tension: 0.1 }
                        ]
                    },
                    options: { responsive: true }
                });
                
                // Adiciona o listener do botão de PDF
                document.getElementById('download-pdf').addEventListener('click', function() {
                     const reportElement = document.getElementById('report-container');
                     html2pdf().from(reportElement).save('relatorio_aposentadoria.pdf');
                });
            ...
            try {
                ...
                comparisonChart = new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [
                            { label: 'Patrimônio com Financiamento', data: results.financiamento, borderColor: 'rgb(220, 53, 69)', tension: 0.1, fill: false },
                            { label: 'Patrimônio com Aluguel', data: results.aluguel, borderColor: 'rgb(10, 66, 117)', tension: 0.1, fill: false },
                            { label: 'Patrimônio com Consórcio (Mediano)', data: results.consorcio, borderColor: 'rgb(40, 167, 69)', borderDash: [5, 5], tension: 0.1, fill: false }
                        ]
                    },
                     options: {
